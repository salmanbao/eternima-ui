...
const WhyEternima = () => {
  ...
  return (
    <section className="w-full py-12 sm:py-20 bg-background" id="why">
      <div className="section-container">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 sm:gap-8">
          {benefits.map((benefit, index) => (
            <div 
              key={index}
              className="p-6 sm:p-8 rounded-2xl bg-gradient-to-br from-muted/50 to-card border border-border hover:shadow-elegant transition-all duration-300 animate-on-scroll"
            >
